...
<div class="footer-container">
  <div id="s-logo-container">
    <a href="https://www.instagram.com/freewill_game/" target="_blank"
      ><img
        class="small-logo"
        id="instagram-logo"
        alt="instagram logo"
        src={currentInstagramImageSrc}
        on:mouseover={instagram_hover}
        on:mouseout={instagram_unhover} /></a>
    <a href="https://www.tiktok.com/@freewillgame" target="_blank"
      ><img
        class="small-logo"
        id="tiktok-logo"
        alt="tiktok logo"
        src={currentTiktokImageSrc}
        on:mouseover={tiktok_hover}
        on:mouseout={tiktok_unhover} /></a>
    <a href="https://twitter.com/FreeWill_Game" target="_blank"
      ><img
        class="small-logo"
        id="twitter-logo"
        alt="twitter logo"
        src={currentTwitterImageSrc}
        on:mouseover={twitter_hover}
        on:mouseout={twitter_unhover} /></a>
  </div>
